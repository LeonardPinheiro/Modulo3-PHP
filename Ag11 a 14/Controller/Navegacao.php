            ...
            if(isset($_POST["btnCadRealizado"])){
                ...
                if(isset($_POST["btnCadNRealizado"])){
                    ...
                    if(isset($_POST["btnAtualizar"])){
                        ...
                        if(isset($_POST["btnPrincipal"]) || isset($_POST["btnAtualizacaoCadastro"]) || isset($_POST["btnOperacaoNRealizada"]) || isset($_POST["btnCadNaoRealizado"]) || isset($_POST["btnInfInserir"]) || isset($_POST["btnInfExcluir"])){
                            include_once '../View/principal.php';
                        }
                        else{
                                                    ...
                                                    if(isset($_POST["btnExcluirEP"])){
                                                        ...
                                                        if(isset($_POST["btnLoginADM"])){
                                                            ...
                                                            if(isset($_POST["btnADM"])){
                                                                require_once '../View/ADMLogin.php';
                                                            }
                                                            else{
                                                                if(isset($_POST["btnListarCadastrados"])){
                                                                    include_once '../View/ADMListarCadastros.php';
                                                                }
                                                                else{
                                                                    if(isset($_POST["btnListarAdministradores"])){
                                                                        ...
                                                                        if(isset($_POST["btnVoltar"])){
                                                                            ...
                                                                            if(isset($_POST["btnVoltarListaCadastro"])){
                                                                                include_once '../View/ADMListarCadastros.php';
                                                                            }
                                                                            else{
                                                                                if(isset($_POST["btnMostrarFormacao"])){
                                                                                    require_once '../Controller/AdministradorController.php';
    
                                                                                    $aController = new AdministradorController();
                                                                                    if($aController->gerarUsuarioInformacoes($_POST['idMostrarFormacoes'])){
